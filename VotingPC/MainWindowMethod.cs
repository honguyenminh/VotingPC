    ...
    public partial class MainWindow : Window
    {
        ...
        private void PopulateVoteUI()
        {
            ...
            foreach (var info in infos)
            {
                ...
                stackPanel.Margin = new Thickness(100, 30, 100, 50);
        ...
        private async void SubmitButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int i = 0; i < infos.Count; i++)
            {
                ...
                {
                    if ((bool)((CheckBox)stacks[i].Children[j]).IsChecked) scales[i][j].Votes++;
                }
            }
        ...
        private void ChangeSlide_Checked(object sender, RoutedEventArgs e)
        {
            ...
            //{
            //    if (infos[index].Scale == (string)((RadioButton)sender).Content){
            //        break;
            //    }
            //    index++;
            //}
        ...
        {
            Transitioner.MoveFirstCommand.Execute(0, TransitionerObj);
        }
        #endregion
    }
}
